...
- (void)makeOutsideShadowWithDirection:(OutsideShadowDirection)direction {
    ...
    CGFloat offset = 3;
    switch (direction) {
        case OutsideShadowDirectionTop:
        {
            self.layer.shadowOffset = CGSizeMake(0, -offset);
            break;
        }
        case OutsideShadowDirectionLeft:
        {
            self.layer.shadowOffset = CGSizeMake(-offset, 0);
            break;
        }
        case OutsideShadowDirectionBottom:
        {
            self.layer.shadowOffset = CGSizeMake(0, offset);
            break;
        }
        case OutsideShadowDirectionRight:
        {
            self.layer.shadowOffset = CGSizeMake(0, offset);
            break;
        }
